...
{
	//BBS log file at C:\\Users\\[yourname]\\AppData\\Roaming\\BambuSlicer\\log\\[log_filename].log
...
{
	return std::string("generated by BambuSlicer " SLIC3R_VERSION " on " ) + Utils::utc_timestamp();
}
