...
static std::vector<std::string> s_Preset_print_options {
    ...
    "bottom_surface_pattern", "internal_solid_infill_pattern", "sub_top_surface_pattern", "infill_direction", "sparse_infill_rotate_template", "solid_infill_rotate_template", "bridge_angle", "infill_shift_step", "skeleton_infill_density", "infill_lock_depth", "skin_infill_depth", "skin_infill_density",
