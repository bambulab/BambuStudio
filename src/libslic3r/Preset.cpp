...
static std::vector<std::string> s_Preset_filament_options {/*"filament_colour", */ "default_filament_colour", "required_nozzle_HRC", "filament_diameter", "volumetric_speed_coefficients", "filament_type",
                                                          "filament_soluble", "filament_is_support", "filament_printable", "filament_support_printable", "filament_scarf_seam_type", "filament_scarf_height",
...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "group_algo_with_time","extruder_max_nozzle_count","enable_filament_dynamic_map"
};
