...
#define NOT_GENERATE_TIMELAPSE                                      "not_generate_timelapse"
    ...
    private:
        ...
        {
            const TimeProcessor* p_time_processor;
            const UsedFilaments* p_used_filaments;
            std::vector<Extruder> p_extruders;
            void initialize(const TimeProcessor& time_processor,const UsedFilaments& used_filaments,const std::vector<Extruder>&extruders){
                p_time_processor=&time_processor;
                p_used_filaments=&used_filaments;
                p_extruders=extruders;
            }
            void reset() {
                p_time_processor = nullptr;
                p_used_filaments = nullptr;
                p_extruders.clear();
            }
    ...
    public:
        ...
        void set_extruders(const std::vector<Extruder> extruders){ m_extruders=extruders;}
