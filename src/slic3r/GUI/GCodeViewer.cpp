...
<<<<<<< HEAD   (9a18c1 FIX: UserPresetsDialog filaments & print presets of current )
...
=======
    if (wxGetApp().app_config->get("helio_enable") == "true") {
        ...
        float text_width          = imgui.calc_text_size(_u8L("Helio Action").c_str()).x;
    ...
    // BBS support helio
>>>>>>> CHANGE (ce7860 NEW:support thermal index)
