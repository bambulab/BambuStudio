            ...
            if (index != -1) {
                ...
                fs->FetchModel(index, [this, fs, dlg, index](int result, std::string const &data) {
                    ...
                    if (gcode_file_count > 0) {
                        ...
                        MessageDialog dlg(this, _L("The .gcode.3mf file contains no G-code data. Please slice it with Bambu Studio and export a new .gcode.3mf file."), wxEmptyString, wxICON_WARNING | wxOK);
