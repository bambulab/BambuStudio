...
static const std::vector<std::string> filament_vendors = {"3DXTECH",  "3Dgunius", "AMOLEN",    "Anycubic",  "Basf",      "Creality",  "Duramic",  "ELEGOO",   "Eryone",
                                                         "FLASHFORGE","FusRock",  "Giantarm",  "HATCHBOX",  "INLAND",    "Justmaker", "Kexcelled","LDO",      "MIKA3D",
                                                         "Novamaker", "OVERTURE", "Polymaker", "Priline",   "Prusament", "Protopasta","SUNLU",   "eSUN",     "iProspect"};
