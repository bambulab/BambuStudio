...
static std::string generate_system_info_json()
{
    ...
    pt::ptree data_node;
    data_node.put("BambuSlicerVersion", SLIC3R_VERSION);
           ...
           wxDEFAULT_DIALOG_STYLE)
{
    ...
    wxString text2 = GUI::format_wxstr(
        _L("We do not send any personal information nor anything that would allow us "
           ...
           "installation are sent. BambuSlicer is open source, if you want to "
    ...
    wxString html = GUI::format_wxstr(
            ...
            "<table><tr><td>"
            "<img src = \"" + resources_dir() + "/icons/BambuSlicer_192px.png\" />"
            "</td><td align=\"left\">"
            + text0 + "<br / ><br / >"
            + text1 + "<br /><br />"
            "</td></tr></table>"
