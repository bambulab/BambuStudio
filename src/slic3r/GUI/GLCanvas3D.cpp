...
bool GLCanvas3D::_render_arrange_menu(float left, float toolbar_height)
{
    ...
    if (arrangement::sparrow_available() && imgui->bbl_checkbox(_L("Use experimental packer"), settings.arrange_use_sparrow)) {
    ...
    if (arrangement::sparrow_available() && settings.arrange_use_sparrow) {
