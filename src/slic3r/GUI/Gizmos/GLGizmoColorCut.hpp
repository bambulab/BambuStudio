#ifndef slic3r_GLGizmoColorCut_hpp_
#define slic3r_GLGizmoColorCut_hpp_
...
class ColorCutPartSelection
{
public:
    ColorCutPartSelection() = default;
    ColorCutPartSelection(
    ...
    ColorCutPartSelection(const ModelObject *mo, int instance_idx_in);
    ~ColorCutPartSelection()
    {
...
class GLGizmoColorCut : public GLGizmoRotate3D
{
private:
    ...
    std::shared_ptr<ColorCutPartSelection>    m_part_selection{nullptr};
...
public:
    GLGizmoColorCut(GLCanvas3D& parent, unsigned int sprite_id);
...
protected:
    ...
    virtual std::string on_get_name_str() override { return "ColorCut"; }
...
#endif // slic3r_GLGizmoColorCut_hpp_
