...
private:
    inline static const wxMediaState MEDIASTATE_IDLE = (wxMediaState) 3;
    inline static const wxMediaState MEDIASTATE_INITIALIZING = (wxMediaState) 4;
    inline static const wxMediaState MEDIASTATE_LOADING = (wxMediaState) 5;
