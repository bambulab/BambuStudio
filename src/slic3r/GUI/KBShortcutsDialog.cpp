...
void KBShortcutsDialog::fill_shortcuts()
{
    ...
    if (wxGetApp().is_editor()) {
        ...
        Shortcuts plater_shortcuts = {
            ...
            {L("Arrow Up"), L("Move selection one step in positive Y direction")},
            {L("Arrow Down"), L("Move selection one step in negative Y direction")},
            {L("Arrow Left"), L("Move selection one step in negative X direction")},
            {L("Arrow Right"), L("Move selection one step in positive X direction")},
            {L("Shift+Any arrow"), L("Move step x0.1 (finer)")},
            {L("Alt+Any arrow"), L("Move step x0.01 (fine)")},
            {L("Alt+Shift+Any arrow"), L("Move step x0.001 (finest)")},
            {"Esc", L("Deselect all")},
