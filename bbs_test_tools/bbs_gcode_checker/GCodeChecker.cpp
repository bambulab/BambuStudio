...
const std::map<std::string, ExtrusionRole> string_to_role_map = {
    { "Perimeter",                  erPerimeter },
    { "External perimeter",         erExternalPerimeter },
    { "Overhang perimeter",         erOverhangPerimeter },
    { "Internal infill",            erInternalInfill },
    { "Solid infill",               erSolidInfill },
    { "Top solid infill",           erTopSolidInfill },
    { "Ironing",                    erIroning },
    { "Bridge infill",              erBridgeInfill },
    { "Gap fill",                   erGapFill },
    { "Skirt",                      erSkirt },
    { "Support material",           erSupportMaterial },
    { "Support material interface", erSupportMaterialInterface },
