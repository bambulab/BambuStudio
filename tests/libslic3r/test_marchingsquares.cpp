...
// The square centres below are written in PrusaSlicer units (see from_prusa_units()).
TEST_CASE("4x4 raster with one ring", "[MarchingSquares]") {
    ...
    rst.draw(square(1., Point(from_prusa_units(500000), from_prusa_units(500000))));
    rst.draw(square(1., Point(from_prusa_units(1500000), from_prusa_units(500000))));
    rst.draw(square(1., Point(from_prusa_units(2500000), from_prusa_units(500000))));
    
    rst.draw(square(1., Point(from_prusa_units(1500000), from_prusa_units(1500000))));
    rst.draw(square(1., Point(from_prusa_units(2500000), from_prusa_units(1500000))));
    
    rst.draw(square(1., Point(from_prusa_units(2500000), from_prusa_units(2500000))));
...
TEST_CASE("4x4 raster with two rings", "[MarchingSquares]") {
    ...
    SECTION("Ambiguous case with 'ac' square") {
        ...
        // Draw a triangle from individual pixels
        rst.draw(square(1., Point(from_prusa_units(3500000), from_prusa_units(2500000))));
        rst.draw(square(1., Point(from_prusa_units(3500000), from_prusa_units(3500000))));
        rst.draw(square(1., Point(from_prusa_units(2500000), from_prusa_units(3500000))));
        
        rst.draw(square(1., Point(from_prusa_units(2500000), from_prusa_units(1500000))));
        rst.draw(square(1., Point(from_prusa_units(1500000), from_prusa_units(1500000))));
        rst.draw(square(1., Point(from_prusa_units(1500000), from_prusa_units(2500000))));
    ...
    SECTION("Ambiguous case with 'bd' square") {
        ...
        // Draw a triangle from individual pixels
        rst.draw(square(1., Point(from_prusa_units(3500000), from_prusa_units(1500000))));
        rst.draw(square(1., Point(from_prusa_units(3500000), from_prusa_units(2500000))));
        rst.draw(square(1., Point(from_prusa_units(2500000), from_prusa_units(1500000))));
        
        rst.draw(square(1., Point(from_prusa_units(1500000), from_prusa_units(2500000))));
        rst.draw(square(1., Point(from_prusa_units(1500000), from_prusa_units(3500000))));
        rst.draw(square(1., Point(from_prusa_units(2500000), from_prusa_units(3500000))));
