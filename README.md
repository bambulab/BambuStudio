...
This is a fork of [BambuStudio-ZAA](https://github.com/adob/BambuStudio-ZAA) by Aleksandr Dobkin, ported to the latest BambuStudio v2.5.0.66 base. It implements a non-planar slicing feature called **Z anti-aliasing** or **contouring**. The basic idea is to dynamically vary the height of extrusions within a single layer to reduce stair-stepping artifacts on top surfaces.

Prebuilt Windows releases are available through the [github releases page](https://github.com/mproper23/BambuStudio-ZAA/releases/).
