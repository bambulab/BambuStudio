var LangText={
    ...
    "pl_PL": {
        ...
        "t2": "Bambu Studio zostanie skonfigurowany w kilku krokach. Zacznijmy!",
		...
		"t52": "Pomiń",
		"t53": "Dołącz",
		"t54": "W społeczności druku 3D uczymy się od sukcesów i porażek innych, aby dostosować nasze własne parametry i ustawienia krojenia. Bambu Studio podąża tą samą zasadą i wykorzystuje uczenie maszynowe do poprawy swojej wydajności na podstawie sukcesów i porażek dużej liczby wydruków naszych użytkowników. Szkolimy Bambu Studio, aby był mądrzejszy, dostarczając mu danych z rzeczywistego świata. Jeśli chcesz, ta usługa uzyska dostęp do informacji z Twoich logów błędów i logów użytkowania, które mogą zawierać informacje opisane w ",
		...
		"t65": "Wysyłanie zadania drukowania przez sieć WLAN",
		...
		"t85": "4, Ponownie otwórz Bambu Studio i zainstaluj wtyczkę ponownie",
		"t86": "Zamknij",
		...
		"t111": "Utwórz nowy profil filamentu",
		"t112": "Dołącz do programu",
		"t113": "Możesz zmieniać swoje preferencje w dowolnym momencie.",
		"t114": "Strona główna",
		"t115": "Jedna partia",
		"t116": "Ponów próbę",
                "t117": "brak informacji o modelu",
		"wk1": "Szybki start",
		"wk2": "Ten artykuł przedstawia najbardziej podstawowe wykorzystanie Bambu Studio. Przewodnik dla użytkowników w konfiguracji oprogramowania, tworzeniu projektów i przeprowadzeniu pierwszego zadania drukowania krok po kroku.",
		"wk3": "Przepływ pracy oparty na projektach",
		"wk4": "Bambu Studio wykorzystuje zaawansowany przepływ pracy do realizacji projektu „wszystko w jednym”. Bazując na popularnym formacie projektu 3MF, dostarcza szereg nowatorskich funkcji, takich jak obsługa wielu płyt, menedżer zasobów projektu oraz widok montażu/części. To znacznie zwiększa efektywność twórców i regularnych użytkowników",
		"wk5": "Drukowanie w wysokiej jakości i z dużą prędkością",
		"wk6": "Trudno jest drukować z dużą prędkością, zachowując przy tym wysoką jakość. Bambu Studio umożliwia to. „Arch Move” pozwala na płynne poruszanie się głowicy i redukuje wibracje maszyny. Inteligentne chłodzenie oparte na dostosowanych parametrach chłodzenia dla każdego rodzaju filamentu. „Automatyczne zwalnianie” dla ścianek wychodzących poza obrys pozwala uniknąć deformacji przy wysokiej prędkości.",
		"wk7": "Drukowanie wielokolorowe",
		"wk8": "Bambu Studio oferuje wszechstronne narzędzia do kolorowania w celu tworzenia kolorowego modelu. Możesz swobodnie dodawać/usuwać filamenty w projekcie i kolorować swój model za pomocą różnych pędzli. Przed drukowaniem każdy filament zostanie automatycznie odwzorowany na pozycję AMS, bez konieczności ręcznej modyfikacji rozmieszczenia cewki w AMS.",
		"wk9": "Przewodnik po ustawieniach wycięcia",
		"wk10": "Funkcje zarządzania ustawieniami Bambu Studio zapewniają bardzo elastyczną i potężną kontrolę nad procesem wycięcia. W tym artykule przedstawiamy organizację ustawień i udostępniamy kilka wskazówek, aby w pełni wykorzystać te funkcje.",
		"wk11": "Zdalne sterowanie i monitorowanie",
		"wk12": "Bambu Studio obsługuje wysyłanie pracy drukowania do drukarki przez sieć WAN/LAN, kontrolując i monitorując każdy aspekt drukarki 3D oraz prac drukowania. Jeśli masz kilka drukarek, łatwo możesz przełączać się między nimi na liście urządzeń.",
		"wk13": "Format STEP",
		"wk14": "W porównaniu z formatem STL, format STEP zapewnia bardziej efektywne informacje. Dzięki dużej dokładności tego formatu można generować wiele ścieżek ekstruzji w postaci łuków. Zawiera także relację montażową każdej części modelu, którą można wykorzystać do przywrócenia widoku montażowego po wycięciu modelu.",
		"wk15": "Tekst 3D",
		"wk16": "Dzięki narzędziu Tekst 3D użytkownicy mogą łatwo tworzyć różne kształty tekstu 3D w projekcie, co sprawia, że model staje się bardziej spersonalizowany. Bambu Studio dostarcza dziesiątki czcionek i obsługuje style pogrubienia i kursywy, aby nadać tekstu większą elastyczność."
    }	
};
