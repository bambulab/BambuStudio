var LangText={
	...
	"ko_KR": {
		...
		"t2": "Bambu Studio는 몇 단계로 설정됩니다. 시작하겠습니다!",
		"t3": "사용자 계약",
		"t4": "동의하지 않음",
		"t5": "동의",
		...
		"t52": "건너뛰기",
		"t53": "가입",
		"t54": "3D 프린팅 커뮤니티에서는 서로의 성공과 실패를 배우고 자신의 슬라이싱 매개변수와 설정을 조정합니다. Bambu Studio는 동일한 원칙을 따르고 기계 학습을 사용하여 우리 사용자들의 방대한 인쇄의 성공과 실패로 그 성능을 개선합니다. 우리는 실제 데이터를 공급하여 Bambu Studio를 더 똑똑하게 훈련시키고 있습니다. 귀하가 원한다면 이 서비스는 오류 로그 및 사용 로그의 정보에 액세스할 것입니다. 여기에는 다음에 설명된 정보가 포함될 수 있습니다.",
		"t55": "개인 정보 정책",
		...
		"t76": "Bambu 네트워크 플러그인이 감지되지 않았습니다. 클릭 ",
		"t77": "여기에",
		"t78": " 설치하려면.",
		"t79": "플러그인 설치 실패. ",
		"t80": "다음 단계를 시도하십시오:",
		"t81": "1, 클릭 ",
		"t82": " 플러그인 디렉토리 열기",
		"t83": "2, 모든 Bambu Studio 닫기",
		"t84": "3, 플러그인 디렉토리의 모든 파일 삭제",
		"t85": "4, Bambu Studio를 다시 열고 플러그인을 다시 설치하십시오",
		"t86": "닫기",
		"t87": "사용자 매뉴얼",
		"t88": "제거",
		"t89": "포함 폴더 열기",
	...
	"pl_PL": {
		...
		"t2": "Konfiguracja Bambu Studio odbywa się w kilka kroków. Zacznijmy!",
		...
		"t52": "Pomiń",
		"t53": "Dołącz",
		"t54": "W społeczności drukowania 3D uczymy się od sukcesów i porażek innych, aby dostosować nasze parametry cięcia i ustawienia. Bambu Studio działa na tej samej zasadzie i wykorzystuje uczenie maszynowe, aby poprawiać swoją wydajność na podstawie sukcesów i niepowodzeń licznych wydruków naszych użytkowników. Trenujemy Bambu Studio, aby stać się mądrzejszą, dostarczając rzeczywiste dane z życia. Jeśli jesteś zainteresowany, ta usługa będzie mieć dostęp do informacji z Twoich dzienników błędów i dzienników użytkowania, które mogą zawierać informacje opisane w",
