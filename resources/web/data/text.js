var LangText={
	"en":{
		...
		"t52":"Skip",
		"t53":"Join",
		"t54":"In the community, we learn from each other's success and failure to adjust our own slicing parameters and printing settings. Bambu Studio follows the same principle and improves its performance by learning success and failure from the vast number of printings, using machine learning capabilities.  In other words, we could train the studio to be more smarter by feeding them the real-world data, just like Tesla to train their Auto Pilot with everyone's driving data.  This service needs to access information about your error logs and usage logs, which may include information described in",
		"t55":"Privacy Policy",
		"t56":".We will not collect your private data such as name, address, bank account, phone number. By enabling this service, you agree to these terms and the Statement about ",
